...
**주로 작업하는 프로젝트에서 1회 실행**하면 충분합니다. 생태계 소스 체크 결과는 어디서 돌려도 동일하고, 글로벌 설정(`~/.claude/`)도 어디서든 읽힙니다. 현재 프로젝트의 CLAUDE.md와 git 히스토리는 추천 필터링 정확도를 높여주는 보너스입니다.

프로젝트마다 따로 돌릴 필요는 없습니다.
